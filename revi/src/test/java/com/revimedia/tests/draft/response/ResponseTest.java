package com.revimedia.tests.draft.response;
...
public class ResponseTest {
    ...
    public void testName() throws Exception {
        ...
        Map<String, String> result = new Gson().fromJson(success, HashMap.class);
...
/*    @Test
    ...
    public void testJSONToList() throws Exception {
        ...
        Map<String, Object> result = gson.fromJson(jsonTxt, HashMap.class);
