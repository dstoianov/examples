...
public class Test1 {
    ...
    public void testName1(String url, parametrized.suitdto.UserTO user) throws Exception {
        System.out.println("url: " + url + ", user: " + user);
    }

    @Test(dataProvider = "create")
    public void testName2(String url, parametrized.suitdto.UserTO user) throws Exception {
        System.out.println("url: " + url + ", user: " + user);
    }
